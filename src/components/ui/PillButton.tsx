...
export function PillButton(props: PillButtonProps) {
  ...
  const base =
    "inline-flex items-center justify-center rounded-full px-6 py-2.5 text-sm font-medium tracking-wide transition-all duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent";
  const styles =
    variant === "primary"
      ? "border border-accent bg-accent text-ground hover:bg-accent-light hover:border-accent-light"
